...
| CIP-0104 | Demonstrates app-provider attribution through settlement views without a reward-marker template, plus a narrated rewards-accounting walkthrough (balances and accrued rewards before/after each settlement, illustrative beneficiary distribution) |
