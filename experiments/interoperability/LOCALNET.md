...
| CIP-0104 | Shows app-provider attribution through the settlement views, without a reward-marker template. Also includes a step-by-step rewards accounting walkthrough: the balances and the accrued rewards before and after each settlement, and an example beneficiary distribution |
