...
One further compliance capability comes from [`openzeppelin-access-control-v1`](https://github.com/OpenZeppelin/canton-contracts/tree/6d861f188979ea7e0468720a98c2f76e2dc58da9/packages/access/access-control-v1): **D4: Authority through Per-Role Privilege Transfer** - each privileged action sits with a named role rather than a single admin. Privileges can be transferred, granted or revoked.
