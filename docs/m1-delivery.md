...
| (shared RI base)                               | CIP-0112 settlement scaffold all four RIs inherit, plus a deep settlement exemplar | [experiments/cip112-settlement/](../experiments/cip112-settlement/), [experiments/settlement-exemplar/](../experiments/settlement-exemplar/) |
...
| ----------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| All library code compiles against the current Daml SDK and passes CI with 100% test pass rate                                       | ✅                | `OZ_DAML_TOOLCHAIN=dpm dpm build --all` on SDK 3.4.11; `./scripts/run-tests.sh` → 130/130 scripts pass; CI in `.github/workflows/ci.yml`                                                                                                                                                                                                                                                                                     |
...
| Architecture documents for Year 1 RIs published and reviewed by Digital Asset                                                       | 🟡 published, review in progress | The four RI reports are published in this (now public) repo under [ri-reports/](ri-reports/); the external review round collects inline comments in [PR #40](https://github.com/OpenZeppelin/canton-specs/pull/40)                                                                                                                                                                                                                       |
