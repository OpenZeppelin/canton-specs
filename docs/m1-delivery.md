...
| ----------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| All library code compiles against the current Daml SDK and passes CI with 100% test pass rate                                       | ✅                | `OZ_DAML_TOOLCHAIN=dpm dpm build --all` on SDK 3.4.11; `./scripts/run-tests.sh` → 131/131 scripts pass (2026-07-21); CI in `.github/workflows/ci.yml`                                                                                                                                                                                                                                                                                     |
